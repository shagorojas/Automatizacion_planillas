...
class TemplateGenerator:
    ...
    def crear_plantilla_control(self, df_plantilla, nombre_df, var_sede, var_codigo_dane_sede, var_jornada, df_encabezado, var_grado, df_parametros):
    ...
    def separar_dataframes(self):
        ...
        try:
            ...
            for i, (nombre_df, df) in enumerate(dfs_separados.items(), start=1):
                ...
                self.crear_plantilla_control(df, nombre_df, var_sede, var_codigo_dane_sede, var_jornada, df_encabezado, var_grado, df_parametros)
        except MunicipioNoSoportadoError as e:
            print(e)  # Muestra el mensaje en la terminal
    ...
    def concatenar_exceles(self):
        ...
        self.limpiar_carpeta_resultado("Resultado planillas en blanco")

        # Carpeta donde están los archivos
        carpeta = "Resultado"
        carpeta_salida = "Resultado planillas en blanco"
