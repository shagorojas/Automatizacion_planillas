...
class GeneradorPlantillas:
    ...
    def convertir_un_excel_a_pdf(self, archivo):
        ...
        ruta_excel = os.path.join(ruta_resultado_combinado, archivo)
        ruta_pdf = os.path.join(ruta_resultado_pdf, archivo.replace(".xlsx", ".pdf"))
    ...
    def convertir_pdf(self):
        ...
        if not os.path.exists(ruta_resultado_pdf):
            os.makedirs(ruta_resultado_pdf)

        archivos_excel = [f for f in os.listdir(ruta_resultado_combinado) if f.endswith(".xlsx")]
    ...
    def main(self):
        ...
        # Convertir los archivos concatenados a PDF
        # self.convertir_pdf()
...
#     # Iniciar Excel
#     excel = win32com.client.Dispatch("Excel.Application")
#     excel.Visible = False  # Para que no abra la interfaz gráfica

#     # Obtener lista de archivos Excel en la carpeta de entrada
#     archivos_excel = [f for f in os.listdir(ruta_resultado_combinado) if f.endswith(".xlsx")]
...
#             ws.PageSetup.Orientation = 2  # xlLandscape (Horizontal)
#             ws.PageSetup.Zoom = False
#             ws.PageSetup.FitToPagesWide = 1  # Ajustar ancho a una página
#             ws.PageSetup.FitToPagesTall = 1  # Ajustar alto a una página
#             ws.PageSetup.LeftMargin = 0
#             ws.PageSetup.RightMargin = 0
#             ws.PageSetup.TopMargin = 0
#             ws.PageSetup.BottomMargin = 0
...
#         # Exportar a PDF
#         wb.ExportAsFixedFormat(0, ruta_pdf)  # 0 = xlTypePDF
